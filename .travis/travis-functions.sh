...
function updateVersionInRenku() {
  echo "Updating renku-gateway version to $CHART_VERSION in Renku's requirements.yaml"
  ...
  sed -i "/- name: renku-gateway/{n;n;n;s/.*/  version: $CHART_VERSION/}" charts/renku/requirements.yaml
