TOKEN_PAYLOAD = {
    ...
    "acr": "1",
    "allowed-origins": [
        "http://gateway.renku.build/*", "http://localhost:5000/*"
    ],
    "realm_access": {
...
GITLAB_PROJECTS = [{
    ...
    "_links": {
        ...
        "merge_requests":
            "http://gitlab.renku.build/api/v4/projects/1/merge_requests",
        "repo_branches":
            "http://gitlab.renku.build/api/v4/projects/1/repository/branches",
    ...
    "owner": {
        ...
        "state": "active",
        "avatar_url":
            "https://www.gravatar.com/avatar/3279e2b7c1a20fc486a409c7b6280485?s=80\u0026d=identicon",
